...
class StorageNode(Node):
    def __init__(self,nodeId,**kwargs):
        self.DOCKER_IMAGE = "nachocode/cinvestav-ds-storage-node"
        self.nodeId       = nodeId
        ...
        self.volume       = kwargs.get("volume","/home/nacho/Documents/test/storage")+"/"+str(nodeId)
        self.detach       = True
    ...
    def run(self,client):
        ...
        volume              = {}
        volume[self.volume] = {'bind':self.storage_path,'mode':'rw'}
